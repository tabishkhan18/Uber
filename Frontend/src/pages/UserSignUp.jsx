    ...
    <div className='flex flex-col justify-between h-screen '>
      <div>
        ...
        <form onSubmit={handleSubmit} className='p-5'>
          <h1 className="text-base my-2">What is your Name?</h1>
          ...
          />
          <h1 className="text-base my-2">Create Password</h1>
          <input
            className="bg-neutral-200 my-2 p-3 w-full rounded placeholder:text-sm"
            type="password"
            value={password}
          ...
          />
          <button className='my-5 bg-black w-full py-2 text-lg font-medium text-white rounded' >Create</button>
        </form>
        <p className='px-5 text-center text-sm'>Already have an Account? <Link to='/user-login' className='text-blue-500'>Login here</Link></p>
      </div>
      <div className='p-5'>
